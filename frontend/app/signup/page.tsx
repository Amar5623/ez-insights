            ...
            <CardContent className="pt-4">
              <form onSubmit={handleSubmit}>
                <FieldGroup>
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-11 mt-2 shadow-md shadow-primary/20 transition-all duration-300 hover:shadow-lg hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] animate-fade-in animation-delay-500" 
                    disabled={isLoading}
                  >
                    {isLoading ? (
                      <>
