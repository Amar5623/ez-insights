...
export function ChatSidebar() {
  ...
  return (
    <aside className="flex h-full w-64 flex-col border-r border-sidebar-border bg-sidebar theme-transition">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-sidebar-border p-4 animate-fade-in">
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary shadow-lg shadow-primary/25 transition-transform duration-300 hover:scale-105">
            <DatabaseIcon className="h-4 w-4 text-primary-foreground" />
          </div>
          <span className="font-semibold text-sidebar-foreground">Ez-Insights</span>
        </div>
        <ThemeToggle />
      </div>
      ...
      <div className="border-t border-sidebar-border p-3 animate-fade-in animation-delay-300">
        <div className="flex items-center gap-3 rounded-xl bg-sidebar-accent/50 p-2.5 transition-colors duration-300 hover:bg-sidebar-accent">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-primary/20 to-primary/10 ring-2 ring-primary/20 transition-transform duration-300 hover:scale-105">
